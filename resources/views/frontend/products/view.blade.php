        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 border-right">
                    <img src="{{ asset('storage/'.$products->image) }}" class="w-100" alt="{{ $products->name }}">
                </div>
                <div class="col-md-8">
                    <h2 class="mb-0">
                        {{ $products->name }}
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-9">
                            <br/>
                            @if ($products->qty > 0)
                            <button type="button" class="btn btn-primary me-3 addToCartBtn float-start">Add To Cart <i class="fa-solid fa-cart-plus"></i></button>
                            @endif
                    ...
                    <div class="user-review">
                        ...
                        @if ($rating)
                            ...
                            @for ($j = $user_rated+1; $j<=5; $j++)
                               <i class="fa fa-star"></i>
                            @endfor
                            <small>Review on {{ $item->created_at ? $item->created_at->format('d-M-Y'):'' }}</small>
                            <p>
                                {{ $item->user_review }}
                            </p>
